...
<%
    ...
    String privil = request.getParameter("priv");
    try{
        Class.forName("com.mysql.jdbc.Driver");
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jspecole","root","");
       PreparedStatement ps = conn.prepareStatement("INSERT INTO t_compte(Username,Password,CodeEnseignant,CodePrivilege) values(?,?,?,?)");
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Creer du compte user</h1>
            ...
            <div class="tile-body">
                <form method="POST" action="">
                   <%
                    ...
                    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jspecole","root","");
                    String id = request.getParameter("id");
                    String privil = request.getParameter("privil");
                    ...
                    {
                        %>
                        <p><%=rs.getString("NomPersonnel")%></p>
                <div class="form-group">
                  <label class="control-label">Username</label>
                  <input name="id" class="form-control" type="hidden"  value="<%=id%>">
                  <input name="privil" class="form-control" type="hidden"  value="<%=privil%>">
                ...
                <%
                    ...
                    %>
                 <div class="form-group">
                     <input class="btn btn-primary" name="create" type="submit" value="Creer">
                </div>
