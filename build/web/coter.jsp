...
<%@include file="include/header_aside.jsp" %>%>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Coter les eleves</h1>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                         <%
                            ...
                            PreparedStatement ps = conn.prepareStatement("SELECT * FROM t_eleve LEFT JOIN t_cotation ON t_eleve.CodeEleve=t_cotation.CodeEleve LEFT JOIN t_cours ON t_cotation.CodeCours=t_cours.CodeCours WHERE t_eleve.CodeClasse=?");
                            ...
                            while(rs.next())
                            {
                                ...
                                %>
                                            <tr>
                                                ...
                                                <td><%=rs.getString("Cote")%> / <%=rs.getString("Ponderation") %></td>
                                                
                                                <td>
                                                    <a href='cotermaintenant.jsp?id=<%=id %>&cours=<%=id2 %>' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-edit'>Coter</i></a>
                                                   </td>
                                            </tr>
                                <%
                            } %>
