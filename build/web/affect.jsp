...
<%
    if(request.getParameter("affect")!=null)
    {
    ...
    try{
       ...
       PreparedStatement ps = conn.prepareStatement("UPDATE t_personnel SET CodeClasse=? WHERE CodePersonnel=?");
       ps.setString(1, classe);
       ps.setString(2, id);
      int x=ps.executeUpdate();
%>
<script>
    alert("Classe affectee à l'enseignant");
</script>
<%
    }catch(Exception e){
        out.println(e);
...
<!--      <div class="app-title">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Affecter à une classe</h3>
            <div class="tile-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                     <input class="btn btn-primary" name="affect" type="submit" value="Affecter">
                </div>
