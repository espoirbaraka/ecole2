...
<%@include file="include/header_aside.jsp" %>%>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Parametres des cours</h1>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                         <%
                            ...
                            while(rs.next())
                            {
                                String id = rs.getString("CodeClasse");
                                %>
                                            <tr>
                                                <td><%=rs.getString("Classe") %></td>
                                                <td>
                                                    <a href='affectcours.jsp?id=<%=id %>' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-edit'>Affecter des cours</i></a>
                                                </td>
                                            </tr>
                                <%
                            } %>
