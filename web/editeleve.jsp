...
<%
    ...
    try{
       ...
       PreparedStatement ps = conn.prepareStatement("UPDATE t_eleve SET NomEleve=?, PostnomEleve=?, PrenomEleve=?, NomPere=? WHERE CodeEleve=?");
       ps.setString(1, nom);
        ...
        while(rs.next())
        {
            %>
                <div class="form-group col-md-3">
                  ...
                  <input name="nom" class="form-control" type="text" placeholder="" value="<%=rs.getString("NomEleve")%>">
                </div>
                <div class="form-group col-md-3">
                  <label class="control-label">Post-nom</label>
                  <input name="postnom" class="form-control" type="text" placeholder="" value="<%=rs.getString("PostnomEleve")%>">
                </div>
                <div class="form-group col-md-3">
                  <label class="control-label">Prenom</label>
                  <input name="prenom" class="form-control" type="text" placeholder="" value="<%=rs.getString("PrenomEleve")%>">
                </div>
                <div class="form-group col-md-3">
                  <label class="control-label">Nom du père</label>
                  <input name="pere" class="form-control" type="text" placeholder="" value="<%=rs.getString("NomEleve")%>">
                </div>
                
                <div class="form-group col-md-4 align-self-end">
                  <button class="btn btn-primary" name="submit" type="submit"><i class="fa fa-edit"></i>Modifier</button>
                </div>
                 <%
        }
                    %>
