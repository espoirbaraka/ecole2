...
<%@include file="include/header_aside.jsp" %>%>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Cotation</h1>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                         <%
                            ...
                            while(rs.next())
                            {
                                String id = rs.getString("CodeCours");
                                %>
                                            <tr>
                                                <td><%=rs.getString("Cours") %></td>
                                                <td><%=rs.getString("Ponderation") %> points</td>
                                                
                                                
                                                <td>
                                                    <a href='coter.jsp?id=<%=id %>' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-edit'>Coter</i></a>
                                                   </td>
                                            </tr>
                                <%
                            } %>
